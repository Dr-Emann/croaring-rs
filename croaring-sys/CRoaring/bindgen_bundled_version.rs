...
pub const ROARING_VERSION: &[u8; 6] = b"4.3.0\0";
...
extern "C" {
    #[doc = " Shrinks internal arrays to eliminate any unused capacity. Returns the number\n of bytes freed."]
    pub fn roaring64_bitmap_shrink_to_fit(r: *mut roaring64_bitmap_t) -> usize;
}
extern "C" {
